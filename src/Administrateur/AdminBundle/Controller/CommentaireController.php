...
use Administrateur\AdminBundle\Entity\Commentaire;
use Administrateur\AdminBundle\Form\CommentaireType;
...
class CommentaireController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdministrateurAdminBundle:Commentaire')->findAll();
     ...
     * @Method("POST")
     * @Template("AdministrateurAdminBundle:Commentaire:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdministrateurAdminBundle:Commentaire')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdministrateurAdminBundle:Commentaire:edit.html.twig")
     */
