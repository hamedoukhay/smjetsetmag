...
use Administrateur\AdminBundle\Entity\Cinema;
use Administrateur\AdminBundle\Form\CinemaType;
...
class CinemaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdministrateurAdminBundle:Cinema')->findAll();
     ...
     * @Method("POST")
     * @Template("AdministrateurAdminBundle:Cinema:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdministrateurAdminBundle:Cinema')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdministrateurAdminBundle:Cinema:edit.html.twig")
     */
