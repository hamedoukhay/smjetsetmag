...
use Administrateur\AdminBundle\Entity\Film;
use Administrateur\AdminBundle\Form\FilmType;
...
class FilmController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AdministrateurAdminBundle:Film')->findAll();
     ...
     * @Method("POST")
     * @Template("AdministrateurAdminBundle:Film:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdministrateurAdminBundle:Film')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdministrateurAdminBundle:Film:edit.html.twig")
     */
